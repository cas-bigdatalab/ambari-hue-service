...
def download_hue():
  ...
  """
  Execute('wget {0}'.format(params.download_url))
  Execute('tar -zxvf hue-3.11.0.tgz -C {0} && rm -f hue-3.11.0.tgz'.format(params.hue_install_dir))
  ...
  Execute('cd /usr/local/hue-3.11.0 && make install')
